...
public class Raiz : MonoBehaviour
{
    ...
    padreObjeto.transform.rotation = Quaternion.Euler(0f, 0f, rotationHijo1);
     ...
     public void Raiz2()
     {
        ...
        hijo2.transform.rotation = Quaternion.Euler(0f, 0f, rotationHijo1);
        hijo3.transform.rotation = Quaternion.Euler(0f, 0f, rotationHijo1);
        }
 ...
 public void Raiz4()
     ...
     //crea el primer hijo
       ...
       // hijo1.transform.localPosition = new Vector3(hijo1.transform.localPosition.x,hijo1.transform.localPosition.y + alturaY, hijo1.transform.localPosition.z);
